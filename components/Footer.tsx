// Footer — нижний колонтитул сайта, статический компонент без состояния
export default function Footer() {
  return (
    // Чёрный фон, отступ сверху 64px
    <footer style={{ backgroundColor: '#000', borderTop: '1px solid #1a1a1a', marginTop: '64px' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '48px 16px' }}>
        {/* Сетка из 4 колонок (адаптивная через auto-fit) */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '32px', marginBottom: '32px' }}>
          ...
          {/* Колонка 3: ссылки "Помощь" — ведут на реальные страницы */}
          <div>
          ...
          {/* Колонка 4: контактная информация с SVG иконками */}
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
              ...
              <p style={{ fontSize: '14px', color: '#999', margin: 0 }}>8 (800) 555-35-35</p>
            </div>
            {/* Email */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p style={{ fontSize: '14px', color: '#999', margin: 0 }}>info@toppizza.ru</p>
            </div>
            {/* Часы работы */}
