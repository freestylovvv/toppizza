  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        <div style={{ position: 'fixed', top: 0, right: 0, bottom: 0, width: '480px', maxWidth: '100%', padding: '32px', overflowY: 'auto', overflowX: 'hidden', background: 'rgba(255,255,255,0.55)', backdropFilter: 'blur(24px) saturate(180%) brightness(1.1)', WebkitBackdropFilter: 'blur(24px) saturate(180%) brightness(1.1)', borderLeft: '1px solid rgba(255,255,255,0.7)', boxShadow: '-4px 0 32px rgba(255,105,0,0.08), inset 1px 0 0 rgba(255,255,255,0.6)' }}>
