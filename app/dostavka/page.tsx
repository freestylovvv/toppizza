...
//
// Статическая страница — нет состояния, нет запросов к БД.
// Доступна по ссылке в подвале (футере) сайта.
// Содержит информацию о зонах доставки, времени работы и способах оплаты.
// ============================================================
